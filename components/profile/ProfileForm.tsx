...
interface ProfileFormProps {
    ...
    onEmailChange: (val: string) => void; // Added email editing capability
    ...
    return (
        <form onSubmit={onSubmit} className="flex-1 flex flex-col gap-5">
            <div className="space-y-4">
                <div className="group">
                    <label className="text-[10px] uppercase font-bold text-slate-500 ml-1 mb-1 block group-focus-within:text-blue-500 transition-colors">Ad Soyad</label>
                ...
                <div className="group">
                    <label className="text-[10px] uppercase font-bold text-slate-500 ml-1 mb-1 block group-focus-within:text-blue-500 transition-colors">Telefon</label>
                    <div className="relative">
                ...
                <div className="group">
                    <label className="text-[10px] uppercase font-bold text-slate-500 ml-1 mb-1 block group-focus-within:text-blue-500 transition-colors">E-Posta</label>
                    <div className="relative">
                ...
                <div>
                    <label className="text-[10px] uppercase font-bold text-slate-500 ml-1 mb-1 block">Ünvan / Rol</label>
